...
window.addEventListener("load", function(){
    ...
    formData = decodeURLComponent(formData);
...
function validateName(){
    ...
    if(cardName.validity.valueMissing){
        cardName.seyCustomValidity("Enter your name as it appears on the card");
    }else{
...
function luhn(idNum){
    ...
    for(var i = 0; i < idNum.length - 1; i >= 0; i-= 2){
